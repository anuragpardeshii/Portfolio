...
export default function About() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch("https://portfolio-api-alpha-six.vercel.app/?vercelToolbarCode=5UdOwX9VK8Ks7_J/send", {
        method: "POST",
        headers: {
  ...
  return (
    ...
    >
      ...
      <p className="text-lg pb-8 pt-8 font-normal text-gray-500 lg:text-xl dark:text-gray-400">
        Proficient in developing responsive and dynamic web applications with
        the MERN stack. Experienced in creating intuitive user interfaces,
        efficient backend solutions, and solving coding challenges, delivering
        impactful projects that combine innovation, scalability, and
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="block max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.linkedin.com/in/pardeshianurag22"
                target="_blank"
              ...
              >
                <LinkedInIcon style={{ fontSize: "2rem", color: "#0A66C2" }} />{" "}
                LinkedIn
              </a>
              <a
